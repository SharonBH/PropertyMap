    ...
    public async Task<AgencyResponse> Handle(GetAgencyRequest request, CancellationToken cancellationToken)
    {
        ...
        var item = await cache.GetOrSetAsync(
            ...
            async () =>
            {
                ...
                return new AgencyResponse(agencyItem.Id, agencyItem.Name, agencyItem.Email, agencyItem.Telephone, agencyItem.Address, agencyItem.Description, agencyItem.LogoURL, agencyItem.PrimaryColor, agencyItem.AdditionalInfo);
            },
